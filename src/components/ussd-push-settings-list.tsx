...
import { EditUssdPushSettingForm } from './edit-ussd-push-setting-form';
...
export default function UssdPushSettingsList({ ussdPushSettings: initialSettings }: { ussdPushSettings: ussd_push_settings[] }) {
  ...
  const [selectedSetting, setSelectedSetting] = React.useState<ussd_push_settings | null>(null);

  const handleEdit = (setting: ussd_push_settings) => {
  ...
  const filteredAndSortedSettings = React.useMemo(() => {
    let sortableItems = [...ussdPushSettings];
  ...
  }, [ussdPushSettings, searchTerm, searchField, sortConfig]);
  ...
  return (
    <>
      ...
      <Dialog open={isEditDialogOpen} onOpenChange={setIsEditDialogOpen}>
        <DialogContent>
            <DialogHeader>
                <DialogTitle>Edit USSD Push Setting</DialogTitle>
            </DialogHeader>
            {selectedSetting && (
                <EditUssdPushSettingForm
